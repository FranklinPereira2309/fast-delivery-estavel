                    ...
                    <div className="relative w-full max-w-[80mm] bg-white p-8 border border-dashed shadow-2xl font-receipt text-[11px] text-black print-container is-receipt animate-in zoom-in duration-200">
                        ...
                        <div className="grid grid-cols-2 gap-4 no-print mt-6">
                            <button
                                ...
                                className="bg-slate-900 text-white py-4 rounded-[1.5rem] font-receipt font-black uppercase text-[12px] shadow-xl hover:bg-black active:scale-95 transition-all flex items-center justify-center"
                            >
                                IMPRIMIR
                            </button>
                            <button
                                onClick={() => setPrintingOrder(null)}
                                className="bg-slate-50 text-slate-400 py-4 rounded-[1.5rem] font-receipt font-black uppercase text-[12px] hover:bg-slate-100 active:scale-95 transition-all flex items-center justify-center"
                            >
                                FECHAR
                            </button>
                        </div>
