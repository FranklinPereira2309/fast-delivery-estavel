        ...
        <div className="p-6 h-full flex flex-col bg-slate-50 dark:bg-slate-950 relative">
            ...
            {printingOrder && businessSettings && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md">
                    <div className="relative w-full max-w-[58mm] bg-white p-4 shadow-2xl font-receipt text-[10px] text-black print-container is-receipt animate-in zoom-in duration-200">
