...
const SplashScreen: React.FC = () => {
  return (
    <div className="fixed inset-0 z-[9999] bg-slate-50 flex flex-col items-center justify-center animate-in fade-in duration-500 p-4">
      <div className="relative">
        ...
        <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-emerald-500 rounded-full border-4 border-slate-50 animate-pulse"></div>
      </div>
      <div className="mt-8 text-center px-4">
        <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase mb-2">Delivery Fast</h1>
